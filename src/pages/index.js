          ...
          <div className="flex-none w-full">
            ...
            <div className="vendor-spaghetti-cont mt-8 lg:px-16">
              ...
              <div className="p-4 pt-8 text-left flex flex-row flex-wrap justify-center align-center">
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-0">CDNs</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-10">Video Delivery Management</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-20">Online Video Platforms</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-30">Encoding / Transcoding</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-0">Players</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-10">Measurement and Analytics</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-20">Data / DRM</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-30">Exchanges</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-0">Televisions</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-10">OTT Platforms</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-20">IP-Enabled Set Top Boxes</p>
                <p className="m-4 px-8 py-4 rounded-md border flex-none text-center text-gray-600 shake delay-30">System Integrators</p>
              </div>
              <p className="font-display uppercase font-semibold text-xl text-primary">
